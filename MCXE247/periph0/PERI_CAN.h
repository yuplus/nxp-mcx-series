...
typedef struct {
  ...
  __IO uint32_t CTRL1_PN;                          /**< Pretended Networking Control 1 Register, offset: 0xB00, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t CTRL2_PN;                          /**< Pretended Networking Control 2 Register, offset: 0xB04, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t WU_MTC;                            /**< Pretended Networking Wake Up Match Register, offset: 0xB08, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t FLT_ID1;                           /**< Pretended Networking ID Filter 1 Register, offset: 0xB0C, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t FLT_DLC;                           /**< Pretended Networking DLC Filter Register, offset: 0xB10, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t PL1_LO;                            /**< Pretended Networking Payload Low Filter 1 Register, offset: 0xB14, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t PL1_HI;                            /**< Pretended Networking Payload High Filter 1 Register, offset: 0xB18, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t FLT_ID2_IDMASK;                    /**< Pretended Networking ID Filter 2 Register / ID Mask Register, offset: 0xB1C, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t PL2_PLMASK_LO;                     /**< Pretended Networking Payload Low Filter 2 Register / Payload Low Mask register, offset: 0xB20, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  __IO uint32_t PL2_PLMASK_HI;                     /**< Pretended Networking Payload High Filter 2 low order bits / Payload High Mask register, offset: 0xB24, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
       uint8_t RESERVED_7[24];
  struct {                                         /* offset: 0xB40, array step: 0x10 */
    __I  uint32_t CS;                                /**< Wake Up Message Buffer register for C/S, array offset: 0xB40, array step: 0x10, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
    __I  uint32_t ID;                                /**< Wake Up Message Buffer Register for ID, array offset: 0xB44, array step: 0x10, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
    __I  uint32_t D03;                               /**< Wake Up Message Buffer Register for Data 0-3, array offset: 0xB48, array step: 0x10, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
    __I  uint32_t D47;                               /**< Wake Up Message Buffer Register Data 4-7, array offset: 0xB4C, array step: 0x10, available only on: FlexCAN0/CAN0 (missing on FlexCAN1/CAN1, FlexCAN2/CAN2) */
  } WMB[CAN_WMB_COUNT];
