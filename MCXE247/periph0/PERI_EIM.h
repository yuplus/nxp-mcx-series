...
typedef struct {
  ...
  __IO uint32_t EICHD1_WORD0;                      /**< Error Injection Channel Descriptor n, Word0, offset: 0x200 */
  __IO uint32_t EICHD1_WORD1;                      /**< Error Injection Channel Descriptor n, Word1, offset: 0x204 */
} EIM_Type;
