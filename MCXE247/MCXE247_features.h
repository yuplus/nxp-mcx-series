...
#ifndef _MCXE247_FEATURES_H_
#define _MCXE247_FEATURES_H_
...
#define FSL_FEATURE_FLASH_PFLASH_BLOCK_COUNT (3)
...
#define FSL_FEATURE_PDB_CHANNEL_COUNT (4)
