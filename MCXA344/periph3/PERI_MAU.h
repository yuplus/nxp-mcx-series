...
typedef struct {
       uint8_t RESERVED_0[2064];
  __IO uint32_t SYS_CTLR;                          /**< System Control, offset: 0x810 */
  __IO uint32_t GEXP_STATUS_IE;                    /**< General Exception Status Interrupt Enable, offset: 0x814 */
  __IO uint32_t GEXP_STATUS;                       /**< General Exception Status, offset: 0x818 */
       uint8_t RESERVED_1[20];
  __IO uint32_t OP_CTRL;                           /**< Operation Control, offset: 0x830 */
       uint8_t RESERVED_2[4];
  __IO uint32_t RES_STATUS_IE;                     /**< Result Status Interrupt Enable, offset: 0x838 */
  __IO uint32_t RES_STATUS;                        /**< Result Status, offset: 0x83C */
  __IO uint32_t RES0;                              /**< Result Register 0, offset: 0x840 */
  __IO uint32_t RES1;                              /**< Result Register 1, offset: 0x844 */
  __IO uint32_t RES2;                              /**< Result Register 2, offset: 0x848 */
  __IO uint32_t RES3;                              /**< Result Register 3, offset: 0x84C */
} MAU_Type;
