...
#define AOI_RSTS {kAOI0_RST_SHIFT_RSTn, kAOI1_RST_SHIFT_RSTn}
...
#define CTIMER_RSTS {kCTIMER0_RST_SHIFT_RSTn, kCTIMER1_RST_SHIFT_RSTn, kCTIMER2_RST_SHIFT_RSTn}
/*! @brief Reset bits for DMA peripheral */
#define DMA_RSTS_N {kDMA0_RST_SHIFT_RSTn}
/*! @brief Reset bits for EIM peripheral */
#define EIM_RSTS_N {kEIM0_RST_SHIFT_RSTn}
/*! @brief Reset bits for ERM peripheral */
#define ERM_RSTS_N {kERM0_RST_SHIFT_RSTn}
/*! @brief Reset bits for EQDC peripheral */
#define EQDC_RSTS {kQDC0_RST_SHIFT_RSTn, kQDC1_RST_SHIFT_RSTn}
/*! @brief Reset bits for FLEXCAN peripheral */
#define FLEXCAN_RSTS_N {kFLEXCAN0_RST_SHIFT_RSTn}
/*! @brief Reset bits for FLEXPWM peripheral */
#define FLEXPWM_RSTS_N {kFLEXPWM0_RST_SHIFT_RSTn, kFLEXPWM1_RST_SHIFT_RSTn}
/*! @brief Reset bits for FREQME peripheral */
#define FREQME_RSTS_N {kFREQME_RST_SHIFT_RSTn}
...
#define LPSPI_RSTS {kLPSPI0_RST_SHIFT_RSTn, kLPSPI1_RST_SHIFT_RSTn}
/*! @brief Reset bits for LPI2C peripheral */
#define LPI2C_RSTS {kLPI2C0_RST_SHIFT_RSTn, kLPI2C1_RST_SHIFT_RSTn}
/*! @brief Reset bits for LPCMP peripheral */
#define LPCMP_RSTS {NotAvail_RSTn, kCMP1_RST_SHIFT_RSTn, kCMP2_RST_SHIFT_RSTn}
/*! @brief Reset bits for MAU peripheral */
#define MAU_RSTS {kMAU0_RST_SHIFT_RSTn}
/*! @brief Reset bits for OPAMP peripheral */
#define OPAMP_RSTS {kOPAMP0_RST_SHIFT_RSTn, kOPAMP1_RST_SHIFT_RSTn, kOPAMP2_RST_SHIFT_RSTn}
