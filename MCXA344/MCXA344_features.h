...
#ifndef _MCXA344_FEATURES_H_
#define _MCXA344_FEATURES_H_

/* SOC module features */

#if defined(CPU_MCXA344VFM)
...
#elif defined(CPU_MCXA344VLF) || defined(CPU_MCXA344VLH) || defined(CPU_MCXA344VLL)
    /* @brief AOI availability on the SoC. */
    #define FSL_FEATURE_SOC_AOI_COUNT (2)
    /* @brief CDOG availability on the SoC. */
    #define FSL_FEATURE_SOC_CDOG_COUNT (1)
...
/* @brief Indirect operation is in low address. */
#define FSL_FEATURE_MAU_INDIRECT_IS_LOW_ADDR  (1)
